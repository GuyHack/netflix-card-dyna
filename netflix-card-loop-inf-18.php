...
<head>
    ...
    <title>Liste des vidéos accessibles pour un public entre 13 et 18 ans</title>
...
<body>
    ...
    // Requete SQL pour récupérer toutes les vidéos visiognable pour un public mineur entre 0 et 13 ans
    ...
    <header>
        <div class="bodyWidth">
            ...
            <div class="header-right">
                ...
                <button class="btn" type="submit" autocomplete="off" tabindex="0" role="link">ABONNEZ-VOUS</button>
                <a href="#" class="authLinks">S'IDENTIFIER</a>
            </div>
        </div>
    </header>
